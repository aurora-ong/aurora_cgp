defmodule AuroraCGPWeb.PersonAuthTest do
  use AuroraCGPWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias AuroraCGP.Persons
  alias AuroraCGPWeb.PersonAuth
  import AuroraCGP.PersonsFixtures

  @remember_me_cookie "_aurora_cgp_web_person_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AuroraCGPWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_person/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AuroraCGPWeb.Endpoint.subscribe(live_socket_id)
