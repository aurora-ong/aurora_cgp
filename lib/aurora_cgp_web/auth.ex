defmodule AuroraCGPWeb.Auth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_aurora_cgp_web_auth_remember_me"
  ...
  the current_person:
      ...
      defmodule AuroraCGPWeb.PageLive do
        use AuroraCGPWeb, :live_view

        on_mount {AuroraCGPWeb.PersonAuth, :mount_current_person}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AuroraCGPWeb.PersonAuth, :ensure_authenticated}] do
